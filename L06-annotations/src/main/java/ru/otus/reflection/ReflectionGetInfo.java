...
public class ReflectionGetInfo {
    public static void main(String[] args) throws NoSuchMethodException {
        ...
        Method annotatedMethodAll = clazz.getMethod("toString");
        Annotation[] annotationsAll = annotatedMethod.getAnnotations();
        System.out.println(Arrays.toString(annotationsAll));
    }
}
